export const packageDevelop = (basicDevelopmentFunction) => {
    return (task,context) => {
...
export const implementProjectPackage = (task,context,basicDevelopmentFunction) => {
    const developmentFunction = packageDevelop(basicDevelopmentFunction);
    return developmentFunction(task,context);
}
