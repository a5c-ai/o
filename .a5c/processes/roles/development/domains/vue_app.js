...
export const buildVueAppDevelop = ({
  ...
  return applyOptionalMiddlewares(
    baseDevelop,
    withDomainContext({ domain: "vue_app", aspects: enabled }),
    planningOpt.enabled ? withDomainPlanning({ domain: "vue_app", checkpoint: planningOpt.checkpoint }) : null,
