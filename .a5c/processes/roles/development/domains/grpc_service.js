...
export const buildGrpcServiceDevelop = ({
  ...
  return applyOptionalMiddlewares(
    baseDevelop,
    withDomainContext({ domain: "grpc_service", aspects: enabled }),
    planningOpt.enabled ? withDomainPlanning({ domain: "grpc_service", checkpoint: planningOpt.checkpoint }) : null,
