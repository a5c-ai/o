...
export const buildCliToolDevelop = ({
  ...
  return applyOptionalMiddlewares(
    baseDevelop,
    withDomainContext({ domain: "cli_tool", aspects: enabled }),
    planningOpt.enabled ? withDomainPlanning({ domain: "cli_tool", checkpoint: planningOpt.checkpoint }) : null,
