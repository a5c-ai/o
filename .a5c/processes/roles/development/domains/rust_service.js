...
export const buildRustServiceDevelop = ({
  ...
  return applyOptionalMiddlewares(
    baseDevelop,
    withDomainContext({ domain: "rust_service", aspects: enabled }),
    planningOpt.enabled ? withDomainPlanning({ domain: "rust_service", checkpoint: planningOpt.checkpoint }) : null,
