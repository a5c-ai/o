...
export const buildGcpPubsubDevelop = ({
  ...
  return applyOptionalMiddlewares(
    baseDevelop,
    withDomainContext({ domain: "gcp_pubsub", aspects: enabled }),
    planningOpt.enabled ? withDomainPlanning({ domain: "gcp_pubsub", checkpoint: planningOpt.checkpoint }) : null,
