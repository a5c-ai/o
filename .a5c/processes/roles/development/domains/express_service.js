...
export const buildExpressServiceDevelop = ({
  ...
  return applyOptionalMiddlewares(
    baseDevelop,
    withDomainContext({ domain: "express_service", aspects: enabled }),
    planningOpt.enabled ? withDomainPlanning({ domain: "express_service", checkpoint: planningOpt.checkpoint }) : null,
