...
export const buildSpringBootServiceDevelop = ({
  ...
  return applyOptionalMiddlewares(
    baseDevelop,
    withDomainContext({ domain: "spring_boot_service", aspects: enabled }),
    planningOpt.enabled ? withDomainPlanning({ domain: "spring_boot_service", checkpoint: planningOpt.checkpoint }) : null,
