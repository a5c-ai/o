...
export const buildDjangoAppDevelop = ({
  ...
  return applyOptionalMiddlewares(
    baseDevelop,
    withDomainContext({ domain: "django_app", aspects: enabled }),
    planningOpt.enabled ? withDomainPlanning({ domain: "django_app", checkpoint: planningOpt.checkpoint }) : null,
