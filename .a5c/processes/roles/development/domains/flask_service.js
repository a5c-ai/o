...
export const buildFlaskServiceDevelop = ({
  ...
  return applyOptionalMiddlewares(
    baseDevelop,
    withDomainContext({ domain: "flask_service", aspects: enabled }),
    planningOpt.enabled ? withDomainPlanning({ domain: "flask_service", checkpoint: planningOpt.checkpoint }) : null,
