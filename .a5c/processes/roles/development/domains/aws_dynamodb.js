...
export const buildAwsDynamodbDevelop = ({
  ...
  return applyOptionalMiddlewares(
    baseDevelop,
    withDomainContext({ domain: "aws_dynamodb", aspects: enabled }),
    planningOpt.enabled ? withDomainPlanning({ domain: "aws_dynamodb", checkpoint: planningOpt.checkpoint }) : null,
