...
export const buildGcpFirestoreDevelop = ({
  ...
  return applyOptionalMiddlewares(
    baseDevelop,
    withDomainContext({ domain: "gcp_firestore", aspects: enabled }),
    planningOpt.enabled ? withDomainPlanning({ domain: "gcp_firestore", checkpoint: planningOpt.checkpoint }) : null,
