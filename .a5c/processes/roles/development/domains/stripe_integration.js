...
export const buildStripeIntegrationDevelop = ({
  ...
  return applyOptionalMiddlewares(
    baseDevelop,
    withDomainContext({ domain: "stripe_integration", aspects: enabled }),
    planningOpt.enabled ? withDomainPlanning({ domain: "stripe_integration", checkpoint: planningOpt.checkpoint }) : null,
