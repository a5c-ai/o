...
export const buildRailsAppDevelop = ({
  ...
  return applyOptionalMiddlewares(
    baseDevelop,
    withDomainContext({ domain: "rails_app", aspects: enabled }),
    planningOpt.enabled ? withDomainPlanning({ domain: "rails_app", checkpoint: planningOpt.checkpoint }) : null,
