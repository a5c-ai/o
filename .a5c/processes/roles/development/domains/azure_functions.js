...
export const buildAzureFunctionsDevelop = ({
  ...
  return applyOptionalMiddlewares(
    baseDevelop,
    withDomainContext({ domain: "azure_functions", aspects: enabled }),
    planningOpt.enabled ? withDomainPlanning({ domain: "azure_functions", checkpoint: planningOpt.checkpoint }) : null,
