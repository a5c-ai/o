...
export const buildKubernetesServiceDevelop = ({
  ...
  return applyOptionalMiddlewares(
    baseDevelop,
    withDomainContext({ domain: "kubernetes_service", aspects: enabled }),
    planningOpt.enabled ? withDomainPlanning({ domain: "kubernetes_service", checkpoint: planningOpt.checkpoint }) : null,
