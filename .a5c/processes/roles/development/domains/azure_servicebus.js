...
export const buildAzureServicebusDevelop = ({
  ...
  return applyOptionalMiddlewares(
    baseDevelop,
    withDomainContext({ domain: "azure_servicebus", aspects: enabled }),
    planningOpt.enabled ? withDomainPlanning({ domain: "azure_servicebus", checkpoint: planningOpt.checkpoint }) : null,
