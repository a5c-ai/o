...
export const buildAwsRdsPostgresDevelop = ({
  ...
  return applyOptionalMiddlewares(
    baseDevelop,
    withDomainContext({ domain: "aws_rds_postgres", aspects: enabled }),
    planningOpt.enabled ? withDomainPlanning({ domain: "aws_rds_postgres", checkpoint: planningOpt.checkpoint }) : null,
