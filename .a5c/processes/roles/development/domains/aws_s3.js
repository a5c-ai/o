...
export const buildAwsS3Develop = ({
  ...
  return applyOptionalMiddlewares(
    baseDevelop,
    withDomainContext({ domain: "aws_s3", aspects: enabled }),
    planningOpt.enabled ? withDomainPlanning({ domain: "aws_s3", checkpoint: planningOpt.checkpoint }) : null,
