...
export const buildTerraformModuleDevelop = ({
  ...
  return applyOptionalMiddlewares(
    baseDevelop,
    withDomainContext({ domain: "terraform_module", aspects: enabled }),
    planningOpt.enabled ? withDomainPlanning({ domain: "terraform_module", checkpoint: planningOpt.checkpoint }) : null,
