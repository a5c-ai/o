...
export const buildFlutterAppDevelop = ({
  ...
  return applyOptionalMiddlewares(
    baseDevelop,
    withDomainContext({ domain: "flutter_app", aspects: enabled }),
    planningOpt.enabled ? withDomainPlanning({ domain: "flutter_app", checkpoint: planningOpt.checkpoint }) : null,
