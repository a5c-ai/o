...
export const buildAwsEventbridgeDevelop = ({
  ...
  return applyOptionalMiddlewares(
    baseDevelop,
    withDomainContext({ domain: "aws_eventbridge", aspects: enabled }),
    planningOpt.enabled ? withDomainPlanning({ domain: "aws_eventbridge", checkpoint: planningOpt.checkpoint }) : null,
