...
export const buildPostgresDbDevelop = ({
  ...
  return applyOptionalMiddlewares(
    baseDevelop,
    withDomainContext({ domain: "postgres_db", aspects: enabled }),
    planningOpt.enabled ? withDomainPlanning({ domain: "postgres_db", checkpoint: planningOpt.checkpoint }) : null,
