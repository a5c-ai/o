...
export const buildNestjsServiceDevelop = ({
  ...
  return applyOptionalMiddlewares(
    baseDevelop,
    withDomainContext({ domain: "nestjs_service", aspects: enabled }),
    planningOpt.enabled ? withDomainPlanning({ domain: "nestjs_service", checkpoint: planningOpt.checkpoint }) : null,
