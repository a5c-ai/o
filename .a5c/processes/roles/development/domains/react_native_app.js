...
export const buildReactNativeAppDevelop = ({
  ...
  return applyOptionalMiddlewares(
    baseDevelop,
    withDomainContext({ domain: "react_native_app", aspects: enabled }),
    planningOpt.enabled ? withDomainPlanning({ domain: "react_native_app", checkpoint: planningOpt.checkpoint }) : null,
