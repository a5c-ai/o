...
export const buildEventStreamingDevelop = ({
  ...
  return applyOptionalMiddlewares(
    baseDevelop,
    withDomainContext({ domain: "event_streaming", aspects: enabled }),
    planningOpt.enabled ? withDomainPlanning({ domain: "event_streaming", checkpoint: planningOpt.checkpoint }) : null,
