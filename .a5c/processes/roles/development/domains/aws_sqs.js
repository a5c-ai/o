...
export const buildAwsSqsDevelop = ({
  ...
  return applyOptionalMiddlewares(
    baseDevelop,
    withDomainContext({ domain: "aws_sqs", aspects: enabled }),
    planningOpt.enabled ? withDomainPlanning({ domain: "aws_sqs", checkpoint: planningOpt.checkpoint }) : null,
