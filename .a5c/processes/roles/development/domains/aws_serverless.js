...
export const buildAwsServerlessDevelop = ({
  ...
  return applyOptionalMiddlewares(
    baseDevelop,
    withDomainContext({ domain: "aws_serverless", aspects: enabled }),
    planningOpt.enabled ? withDomainPlanning({ domain: "aws_serverless", checkpoint: planningOpt.checkpoint }) : null,
