...
export const buildHelmChartDevelop = ({
  ...
  return applyOptionalMiddlewares(
    baseDevelop,
    withDomainContext({ domain: "helm_chart", aspects: enabled }),
    planningOpt.enabled ? withDomainPlanning({ domain: "helm_chart", checkpoint: planningOpt.checkpoint }) : null,
