...
export const buildAngularAppDevelop = ({
  ...
  return applyOptionalMiddlewares(
    baseDevelop,
    withDomainContext({ domain: "angular_app", aspects: enabled }),
    planningOpt.enabled ? withDomainPlanning({ domain: "angular_app", checkpoint: planningOpt.checkpoint }) : null,
