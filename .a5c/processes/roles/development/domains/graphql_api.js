...
export const buildGraphqlApiDevelop = ({
  ...
  return applyOptionalMiddlewares(
    baseDevelop,
    withDomainContext({ domain: "graphql_api", aspects: enabled }),
    planningOpt.enabled ? withDomainPlanning({ domain: "graphql_api", checkpoint: planningOpt.checkpoint }) : null,
