...
export const buildFastapiServiceDevelop = ({
  ...
  return applyOptionalMiddlewares(
    baseDevelop,
    withDomainContext({ domain: "fastapi_service", aspects: enabled }),
    planningOpt.enabled ? withDomainPlanning({ domain: "fastapi_service", checkpoint: planningOpt.checkpoint }) : null,
