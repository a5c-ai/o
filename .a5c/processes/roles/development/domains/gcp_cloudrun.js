...
export const buildGcpCloudRunDevelop = ({
  ...
  return applyOptionalMiddlewares(
    baseDevelop,
    withDomainContext({ domain: "gcp_cloudrun", aspects: enabled }),
    planningOpt.enabled ? withDomainPlanning({ domain: "gcp_cloudrun", checkpoint: planningOpt.checkpoint }) : null,
